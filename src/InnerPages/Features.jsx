...
const Features = ({index}) => {
  return (
    ...
    className='flex mt-[100px] font-sans  flex-col p-[65px 50px] gap-10 justify-center items-center'>
        ...
        <motion.p variants={textVariant()}  className='xs:mt-[10px] sm:mt-[10px] text-center md:mt-3 text-[20px] sm:w-[411px] sm:h-[90px] flex items-center leading-[30px] tracking-[0.2px] md:w-[700px] md:h-[60px] p-[20px] pl-[30px]'> Most calendars are designed for teams. Slate is designed for freelancers who want a simple way to plan their schedule.</motion.p>
        <motion.div className="flex justify-center flex-wrap gap-6 p-5">
         ...
         <motion.div  variants={fadeIn("left", "spring", index * 0.5, 1)}
